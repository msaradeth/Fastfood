...
class ScrollVC: UIViewController {
    ...
    var layoutManager: LayoutManagerScroll!
    
    @IBOutlet weak var collectionViewTopConstraint: NSLayoutConstraint!
    @IBOutlet weak var mapView: MKMapView!
    @IBOutlet weak var collectionView: UICollectionView!
    static func createWith(title: String, viewModel: SearchViewModel) -> ScrollVC {
        let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "ScrollVC") as! ScrollVC
    ...
    func setupVC() {
        ...
        layoutManager = LayoutManagerScroll(collectionView: collectionView,
                                      topInset: topInset,
        ...
        if UIDevice.current.userInterfaceIdiom == .phone {
            ...
            DispatchQueue.main.async {
                self.layoutManager.currentConstraintValue = self.layoutManager.centerConstraintValue
            }
        }
    }
...
extension ScrollVC: UICollectionViewDataSource {
...
extension ScrollVC: UICollectionViewDelegateFlowLayout {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if translation.y > 0 && layoutManager.startScrollFromTop {
            ...
            if (layoutManager.isAtTop() && collectionView.indexPathsForVisibleItems.contains(IndexPath(row: 0, section: 0))) {
                ...
                layoutManager.enableGestures()
                collectionView.isScrollEnabled = false
                layoutManager.currentConstraintValue = layoutManager.centerConstraintValue
            }
        }
    }
